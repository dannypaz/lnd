...
func (PaymentState) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (Failure_FailureCode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{7, 0} }
...
type SendPaymentRequest struct {
	...
	PaymentRequest string `protobuf:"bytes,5,opt,name=payment_request,json=paymentRequest" json:"payment_request,omitempty"`
	// *
	// An upper limit on the amount of time we should spend when attempting to
	// fulfill the payment. This is expressed in seconds. If we cannot make a
	// successful payment within this time frame, an error will be returned.
	// This field must be non-zero.
	TimeoutSeconds int32 `protobuf:"varint,6,opt,name=timeout_seconds,json=timeoutSeconds" json:"timeout_seconds,omitempty"`
	// *
	// The maximum number of satoshis that will be paid as a fee of the payment.
	// If this field is left to the default value of 0, only zero-fee routes will
	// be considered. This usually means single hop routes connecting directly to
	// the destination. To send the payment without a fee limit, use max int here.
	FeeLimitSat int64 `protobuf:"varint,7,opt,name=fee_limit_sat,json=feeLimitSat" json:"fee_limit_sat,omitempty"`
	// *
	// The channel id of the channel that must be taken to the first hop. If zero,
	// any channel may be used.
	OutgoingChanId uint64 `protobuf:"varint,8,opt,name=outgoing_chan_id,json=outgoingChanId" json:"outgoing_chan_id,omitempty"`
	// *
	// An optional maximum total time lock for the route. If zero, there is no
	// maximum enforced.
	CltvLimit int32 `protobuf:"varint,9,opt,name=cltv_limit,json=cltvLimit" json:"cltv_limit,omitempty"`
}
...
func (*TrackPaymentRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type PaymentStatus struct {
	...
	State PaymentState `protobuf:"varint,1,opt,name=state,enum=routerrpc.PaymentState" json:"state,omitempty"`
	// *
	// The pre-image of the payment when state is SUCCEEDED.
	Preimage []byte `protobuf:"bytes,2,opt,name=preimage,proto3" json:"preimage,omitempty"`
	// *
	// The taken route when state is SUCCEEDED.
	Route *lnrpc.Route `protobuf:"bytes,3,opt,name=route" json:"route,omitempty"`
}
...
func (*PaymentStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*RouteFeeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*RouteFeeResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
type SendToRouteRequest struct {
	...
	Route *lnrpc.Route `protobuf:"bytes,2,opt,name=route" json:"route,omitempty"`
}
...
func (*SendToRouteRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
type SendToRouteResponse struct {
	...
	Failure *Failure `protobuf:"bytes,2,opt,name=failure" json:"failure,omitempty"`
}
...
func (*SendToRouteResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
type Failure struct {
	...
	Code Failure_FailureCode `protobuf:"varint,1,opt,name=code,enum=routerrpc.Failure_FailureCode" json:"code,omitempty"`
	// *
	...
	ChannelUpdate *ChannelUpdate `protobuf:"bytes,3,opt,name=channel_update,json=channelUpdate" json:"channel_update,omitempty"`
	// / A failure type-dependent htlc value.
	HtlcMsat uint64 `protobuf:"varint,4,opt,name=htlc_msat,json=htlcMsat" json:"htlc_msat,omitempty"`
	...
	CltvExpiry uint32 `protobuf:"varint,6,opt,name=cltv_expiry,json=cltvExpiry" json:"cltv_expiry,omitempty"`
...
func (*Failure) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
type ChannelUpdate struct {
	...
	MessageFlags uint32 `protobuf:"varint,10,opt,name=message_flags,json=messageFlags" json:"message_flags,omitempty"`
	// *
	...
	ChannelFlags uint32 `protobuf:"varint,5,opt,name=channel_flags,json=channelFlags" json:"channel_flags,omitempty"`
	// *
	// The minimum number of blocks this node requires to be added to the expiry
	// of HTLCs. This is a security parameter determined by the node operator.
	// This value represents the required gap between the time locks of the
	// incoming and outgoing HTLC's set to this node.
	TimeLockDelta uint32 `protobuf:"varint,6,opt,name=time_lock_delta,json=timeLockDelta" json:"time_lock_delta,omitempty"`
	// *
	// The minimum HTLC value which will be accepted.
	HtlcMinimumMsat uint64 `protobuf:"varint,7,opt,name=htlc_minimum_msat,json=htlcMinimumMsat" json:"htlc_minimum_msat,omitempty"`
	// *
	// The base fee that must be used for incoming HTLC's to this particular
	// channel. This value will be tacked onto the required for a payment
	// independent of the size of the payment.
	BaseFee uint32 `protobuf:"varint,8,opt,name=base_fee,json=baseFee" json:"base_fee,omitempty"`
	// *
	// The fee rate that will be charged per millionth of a satoshi.
	FeeRate uint32 `protobuf:"varint,9,opt,name=fee_rate,json=feeRate" json:"fee_rate,omitempty"`
	// *
	// The maximum HTLC value which will be accepted.
	HtlcMaximumMsat uint64 `protobuf:"varint,11,opt,name=htlc_maximum_msat,json=htlcMaximumMsat" json:"htlc_maximum_msat,omitempty"`
	// *
...
func (*ChannelUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*ResetMissionControlRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*ResetMissionControlResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*QueryMissionControlRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }

// / QueryMissionControlResponse contains mission control state per node.
type QueryMissionControlResponse struct {
	Nodes []*NodeHistory `protobuf:"bytes,1,rep,name=nodes" json:"nodes,omitempty"`
}
...
func (*QueryMissionControlResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
type NodeHistory struct {
	...
	LastFailTime int64 `protobuf:"varint,2,opt,name=last_fail_time" json:"last_fail_time,omitempty"`
	// / Estimation of success probability for channels not in the channel array.
	OtherChanSuccessProb float32 `protobuf:"fixed32,3,opt,name=other_chan_success_prob" json:"other_chan_success_prob,omitempty"`
	// / Historical information of particular channels.
	Channels []*ChannelHistory `protobuf:"bytes,4,rep,name=channels" json:"channels,omitempty"`
}
...
func (*NodeHistory) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
type ChannelHistory struct {
	...
	MinPenalizeAmtSat int64 `protobuf:"varint,3,opt,name=min_penalize_amt_sat" json:"min_penalize_amt_sat,omitempty"`
	// / Estimation of success probability for this channel.
	SuccessProb float32 `protobuf:"fixed32,4,opt,name=success_prob" json:"success_prob,omitempty"`
}
...
func (*ChannelHistory) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (c *routerClient) SendPayment(ctx context.Context, in *SendPaymentRequest, opts ...grpc.CallOption) (Router_SendPaymentClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Router_serviceDesc.Streams[0], c.cc, "/routerrpc.Router/SendPayment", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) TrackPayment(ctx context.Context, in *TrackPaymentRequest, opts ...grpc.CallOption) (Router_TrackPaymentClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Router_serviceDesc.Streams[1], c.cc, "/routerrpc.Router/TrackPayment", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) SendToRoute(ctx context.Context, in *SendToRouteRequest, opts ...grpc.CallOption) (*SendToRouteResponse, error) {
	...
	err := grpc.Invoke(ctx, "/routerrpc.Router/SendToRoute", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) ResetMissionControl(ctx context.Context, in *ResetMissionControlRequest, opts ...grpc.CallOption) (*ResetMissionControlResponse, error) {
	...
	err := grpc.Invoke(ctx, "/routerrpc.Router/ResetMissionControl", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) QueryMissionControl(ctx context.Context, in *QueryMissionControlRequest, opts ...grpc.CallOption) (*QueryMissionControlResponse, error) {
	...
	err := grpc.Invoke(ctx, "/routerrpc.Router/QueryMissionControl", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
